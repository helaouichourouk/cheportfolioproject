...
export default function Footer() {
  return (
    <footer className="flex w-full flex-col items-center gap-20 bg-transparent px-6 py-8 sm:px-14 md:px-20">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 rounded-2xl bg-cyan-500    p-8 text-background sm:p-12 md:gap-12 lg:p-20">
        ...
        <a
          ...
          target="_blank"
          className="mb-3 cursor-pointer text-center text-2xl font-bold underline sm:text-4xl lg:text-7xl"
        >
